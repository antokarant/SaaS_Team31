...
class LatestQuestions extends React.Component
{
    ...
    {
        let url = `https://saas-team31-soa-esb.herokuapp.com/question/popular`;
        axios.get(url,
            {
                headers: {
    ...
    {
        let url = `https://saas-team31-soa-esb.herokuapp.com/question/latest`;
        axios.get(url,
            {
                headers: {
                "Authorization": `bearer ${localStorage.getItem("token")}`
    ...
    {
        let url = `https://saas-team31-soa-esb.herokuapp.com/keyword/popular`;
        axios.get(url,
            {
                headers: {
                "Authorization": `bearer ${localStorage.getItem("token")}`
